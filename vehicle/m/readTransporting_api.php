...
<td><?PHP echo $res2['date_time'];?></td>
 ...
 <tr>
<td>Passengr</td>
<td> <a href="tel:<?PHP echo $ph;?>">Call</a>&nbsp|&nbsp<a href="sms:<?PHP echo $ph;?>">Text</a></td>
</tr>
<tr>       
<td>Pickup</td>
<td> <a href="https://www.google.com/maps/dir/?api=1&origin=<?PHP echo $epk;?>&destination=<?PHP echo $edp;?>&dir_action=navigate"><?PHP echo $pk;?></a></td>
</tr>

<tr>       
<td>Dropoff</td>
<td> <a href="https://www.google.com/maps/dir/?api=1&destination=<?PHP echo $edp;?>&dir_action=navigate"><?PHP echo $dp;?></a></td>
</tr>
<?
echo "<tr>";
echo "<td>ETA</td>";
