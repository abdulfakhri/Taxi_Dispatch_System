...
if(isset($_POST["action"])){ 
 ...
 if($_POST["action"] == "Load"){
  $api_key=$_SESSION['id'];
  $statement = $connPDO->prepare("SELECT * FROM taxi_drivers WHERE taxi_comp='$api_key' ORDER BY driver_id DESC");
  $statement->execute();
   ...
   foreach($result as $row){
    ...
    <tr>
     ...
     <td>'.$row["license_plate"].'</td>
       ...
       <td><button type="button" class="btn-sm" style="color:white;" id="ebtn"><a href="/dispatch/m/reportsAPI/fetchReportsAPI.php?d='.$row['driverId'].'">Get Report<a></button></td>
