...
if(e.ctrlKey &&e.which == 78) {
   ...
   location.replace('/dispatch/v/home.php', '_self');
    ...
    location.replace('/dispatch/v/reg_dispatcher.php', '_self');
       ...
       location.replace('/dispatch/v/drivers/createDrivers.php', '_self');
       ...
       location.replace('/dispatch/v/fsetup.php', '_self');
...
<script>
  function openfare() {
   ...
   function TalkToAll() {
       ...
       window.location.href ="/dispatch/chat/newchat.php";
    }
   ...
   // setTimeout("home()",0 );
    ...
    function drivers() {
      window.location.href = "/dispatch/v/drivers/createDrivers.php";
    }
    function vehicles() {
