...
$conn = new PDO( 'mysql:host=localhost;dbname=bnsznyem_ice', $username, $password ); // Create Object of PDO class by connecting to Mysql database
*/
...
if($_POST["action"] == "Create"){
  $statement = $connPDO->prepare("INSERT INTO dispatcher(name,companyId,password,taxi_comp) VALUES(:first_name,:companyid,:password,:key)");
