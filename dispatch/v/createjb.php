...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
      ...
      <div class="col-lg-8" style="background-color:;  border-radius:5px;width:70%; border:1px solid #ccc">
       ...
       <input id="" name="src_addr" type="text" class="" oninput="initialize()"  placeholder="Enter Pickup Address" required><br>
      ...
      <input class="input-half" type="text-fs" placeholder="At:" name="at">
       ...
       <select class="selectT" name="service">
        ...
        <option>Roadside</option>
         ...
         <label>DropOff :</label>
        <input  id=""  name="dest_addr" type="text"  class="" oninput="initialize()"   placeholder="Enter Drop Address" required><br>
