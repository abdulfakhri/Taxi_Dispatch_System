  ...
  <div class="overlay-content">
      ...
      <div class="col-lg-4" style="background-color:;  border-radius:5px;width:30%;height:80%; border:1px solid #ccc">
       ...
       <br></br>
        ...
        <input class="" type="text-half" placeholder="" name="date_time" value="<?PHP echo $now;?>" required>
...
<br></br>
      ...
      <input type="text-fs-sm"  name="" placeholder="Driver" disabled>
       <?php 
     ...
     <input class="input-half" type="text-fs" placeholder="First Mile Charge" name="fmile_charge" required>
      ...
      <input class="input-half" type="text-fs-sm" placeholder="Distance" name="czf" disabled>
      <input class="input-half" type="text-fs-sm" placeholder="Paytment" name="czf" disabled>
      <input class="input-half" type="text-fs" placeholder="Fare Override" name="distance_charge">
